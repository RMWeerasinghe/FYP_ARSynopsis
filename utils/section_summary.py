class SectionSummary:
    ...
    high_sentiments: dict
        {Positive:[list of sentences], Negative: [list of sentences]]}
    sentiment_stats: dict
        {postive_prop:flot, negative_prop: float,Neutral_Prop:float}
    ...
    def __init__(self,section_id) -> None:
        ...
        self.summary = ""
        self.mapping = []
        self.high_sentiments = {"pos":None,"neg":None}
        self.sentiment_prop = {"pos":None, "neg":None, "neu":None}
    ...
    def set_sentiment(self, sents_dict,props_dict):
        self.high_sentiments = sents_dict
        self.sentiment_prop = props_dict
